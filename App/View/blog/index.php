...
if (isset($posts)) {
    foreach ($posts as $post) {
        ...
        <div class="row mt-4 blog_post_div">
            ...
            <p class="blog_line_description"><?= $post->getUpdatedDate() . ' · ' . $post->getReadingTime() . 'min <span class="small_screen_hide">· </span><span class="small_screen_show"><br></span>' . $post->getHeader(); ?></p>
        </div>
    <?php }
}
