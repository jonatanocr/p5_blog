...
<div class="row">
    ...
    <p class="post_line_header"><?= htmlspecialchars($post_data['post']->getReadingTime()) . 'min · ' . htmlspecialchars($post_data['post']->getHeader()); ?></p>
    <p class="post_line_content mt-4"><?= htmlspecialchars($post_data['post']->getContent()); ?></p>
</div>
<div class="row comments_div">
    ...
    <form action="index.php?action=comment-add_comment-<?= htmlspecialchars($post_data['post']->getId()); ?>" method="post">
        <div class="container">
